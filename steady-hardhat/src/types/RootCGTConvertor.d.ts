...
interface RootCGTConvertorInterface extends ethers.utils.Interface {
  functions: {
...
export class RootCGTConvertor extends BaseContract {
  ...
  interface: RootCGTConvertorInterface;
  ...
  filters: {
    Merge(
      ...
      { src: string; mergedAmount: BigNumber; price: BigNumber }
    >;
    ...
    Split(
      ...
      [string, BigNumber, BigNumber],
      { src: string; splitAmount: BigNumber; price: BigNumber }
    >;
  };
