...
interface UnsteadyInterface extends ethers.utils.Interface {
  functions: {
...
export class Unsteady extends BaseContract {
  ...
  functions: {
    ...
    getAlchemist(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setAlchemist(_router: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    getAlchemist(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAlchemist(overrides?: CallOverrides): Promise<PopulatedTransaction>;
